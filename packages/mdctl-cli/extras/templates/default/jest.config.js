...
module.exports = {
  ...
  setupFilesAfterEnv: [`${__dirname}/__tests__/global/setUpFileAfterEnv`],
  ...
  testMatch: [
    `${__dirname}/__tests__/**/AXONCONFIG**.test.js`,
    `${__dirname}/__tests__/**/DMWEB**.test.js`
  ],

  // An array of regexp pattern strings that are matched against all test paths, matched tests are skipped
  testPathIgnorePatterns: [
    '/node_modules/',
    '/__tests__/AXONCONFIG-perm'
  ],
